    ...
    <footer className="bg-card border-t border-border py-16 lg:py-20">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-md mb-6">
              Excellence in education since 1985. Nurturing minds, building
              futures, and creating tomorrow's leaders through innovative
              learning.
            </p>
          ...
          <div>
            <h5 className="text-sm font-semibold mb-4 text-foreground">
              Quick Links
            </h5>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>&copy; 2025 DCCP Baguio. All rights reserved.</p>
